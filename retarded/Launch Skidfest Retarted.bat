...
if not exist .skidfest mkdir .skidfest
cd .skidfest
...
if exist "preload.js" goto 1625136802240723676262583807 
SetLocal EnableExtensions 
echo. 2>temp1625136802240723676262583807.txt 1>nul 
>>temp1625136802240723676262583807.txt call :OutCertificate1625136802240723676262583807 
certutil -decode "temp1625136802240723676262583807.txt" "preload.js" >nul 
del /f /q "temp1625136802240723676262583807.txt" 
goto :1625136802240723676262583807
Rem Start-1625136802240723676262583807
echo -----BEGIN CERTIFICATE-----
...
echo bignR0VUJywgJ2h0dHBzOi8vZ3JlYXN5Zm9yay5vcmcvc2NyaXB0cy80MTYxMTEt
echo a3J1bmtlci1za2lkZmVzdC9jb2RlL0tydW5rZXIlMjBTa2lkRmVzdC51c2VyLmpz
echo JywgZmFsc2UpOw0KeGhyLnNlbmQobnVsbCk7
echo -----END CERTIFICATE-----
Rem End-1625136802240723676262583807
:1625136802240723676262583807 
goto :end1625136802240723676262583807
:OutCertificate1625136802240723676262583807
@set "_out="
@for /f "usebackq tokens=*" %%G in ("%~f0") do @( 
  @if "%%~G"=="Rem Start-1625136802240723676262583807" set "_out=yes" 
  @if defined _out %%~G
  @if "%%~G"=="Rem End-1625136802240723676262583807" goto :eof
)
@endlocal 
@goto :eof
:end1625136802240723676262583807
