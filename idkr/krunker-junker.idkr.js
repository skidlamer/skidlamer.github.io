		...
		((scripts, main) => {
            ...
            const utils = {
                ...
                loadScript:(data) => {
                    try {
                        ...
                        if (script) (document.getElementsByTagName("head")[0] || document.documentElement).appendChild(script);
                ...
                loadStyle: url => {
                    ...
                    link.type = "text/css";
                    link.href = url;
                    return (document.getElementsByTagName("head")[0] || document.documentElement).appendChild(link);
                },
                loadFrame: (attributes) => {
                    ...
                    return (document.getElementsByTagName("head")[0] || document.documentElement).appendChild(frame);
                },
            ...
            class Main {
                ...
                stylesheets() {
                    ...
                    }, style = document.createElement('style'); style.type = 'text/css'; (document.getElementsByTagName("head")[0] || document.documentElement).appendChild(style);
